...
function Footer() {
  return (
    <div className='h-56 shadow-xl text-white bg-black mt-9 flex'>
        <div className='flex-1 pt-6  pl-20'><Image width={90} src="/logo.png" />
        <p className='text-md font-semibold'>Unlocking Knowledge, Empowering Minds: eduXpert  Your Pathway to Excellence!</p>
        </div>
